...
export default async function AdminPozoPage() {
  ...
  return (
    <div className="space-y-4">
      <h1 className="text-xl font-bold text-prode-green sm:text-2xl">💰 Pozo</h1>
      ...
      <div className="card">
        <div className="text-sm text-gray-500">Organización (30%)</div>
        <div className="text-lg font-bold text-prode-green">{formatARS(pozo.organizacion)}</div>
      </div>

      <section className="card">
        <h2 className="mb-2 text-lg font-bold text-prode-green">Historial de pagos</h2>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b text-left text-xs uppercase text-gray-500">
                ...
                <th className="py-2 pr-2">Confirmó</th>
